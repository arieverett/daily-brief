...
COUNTRY_SCHEMA = {
    ...
    "properties": {
        ...
        "quick_hits": {"type": "array", "items": STORY_SCHEMA, "minItems": 2, "maxItems": 4},
    },
...
- Each country: one lead, 2-4 secondary stories, and 2-4 quick hits. Do not repeat an item within a country.
